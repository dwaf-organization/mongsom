...
export default function BestReviewSection() {
  return (
    <InnerPaddingSectionWrapper className='md:py-20'>
      <div>
        <h2 className='text-start text-2xl md:text-4xl font-bold text-primary-200 font-montserrat md:mb-4'>
          Best Review
        </h2>
        <p className='text-start text-primary-200 text-sm md:text-lg mb-8 md:mb-12'>
          사랑하는 사람에게 소중한 선물을 해보세요.
        </p>
      </div>

      <ul className=' md:grid-cols-2 lg:grid-cols-3 md:mb-10'>
        <li className='grid grid-cols-3 gap-1 md:gap-6'>
